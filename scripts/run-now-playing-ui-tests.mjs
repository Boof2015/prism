...
const tempDir = await mkdtemp(join(tmpdir(), 'prism-now-playing-ui-tests-'))
const bundledTestPath = join(tempDir, 'now-playing-ui.test.mjs')
const entryPoint = join(rootDir, 'test', 'now-playing-ui.test.tsx')
